...
// function analyseColor (colorName) {
//     if (colorName === "blue"){
...
console.log(analyseColor(userInputColor));
...
let result = calculateTotal(luckyNumber,totalBill)
alert ("Your price after discount is " + result + "!");
console.log(result);
...
let input = confirm("Would you like to enter a number?");
if (input === true) {
    let num = prompt("Please enter a number");
    if (isNaN(num)) {
        alert("You put in the wrong data type, try again");
    } else {
        if (num % 2 === 0) {
        ...
        alert("Your number was " + (parseInt(num) + 100) + "!");
        if (num > 0) {
